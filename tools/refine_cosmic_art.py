...
icons={
 'shield':'<circle cx="128" cy="128" r="86" fill="#91d7d9" fill-opacity=".28" stroke="#91d7d9" stroke-width="15"/><circle cx="128" cy="128" r="93" fill="none" stroke="#321e3d" stroke-width="5"/><circle cx="128" cy="134" r="42" fill="#f5a451"/><circle cx="114" cy="126" r="6" fill="#321e3d" stroke="none"/><circle cx="142" cy="126" r="6" fill="#321e3d" stroke="none"/><path d="M112 145Q128 158 144 145" fill="none" stroke="#321e3d" stroke-width="7"/><path d="M68 106A64 64 0 0 1 112 66" fill="none" stroke="#fff0ce" stroke-width="10"/>',
...
'cannon':'<path d="M34 128L90 102V154Z" fill="#f5a451"/><g transform="translate(-30 -26) scale(1.2)"><path d="M128 72L150 60L166 76L154 96L132 94Z" fill="#fff0ce"/><path d="M150 116L176 108L192 126L180 148L154 144Z" fill="#f5cf79"/><path d="M126 164L148 160L160 180L144 198L124 190Z" fill="#fff0ce"/><path d="M188 76L204 72L212 88L198 98Z" fill="#f5a451"/><path d="M196 166L214 170L210 188L194 184Z" fill="#f5a451"/></g>',
'lance':'<rect x="34" y="108" width="176" height="40" rx="20" fill="#91d7d9"/><path d="M52 128H196" fill="none" stroke="#fff0ce" stroke-width="12"/><path d="M204 96L232 128L204 160Z" fill="#fff0ce"/><ellipse cx="96" cy="128" rx="16" ry="44" fill="none" stroke="#f5a451" stroke-width="10"/><ellipse cx="150" cy="128" rx="16" ry="44" fill="none" stroke="#f5a451" stroke-width="10"/>',
...
print('Rebuilt rings, shield shell, armour, eclipse, round shot and eleven illustrated power icons')
