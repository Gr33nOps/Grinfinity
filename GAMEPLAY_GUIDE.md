...
| Boldcrest | Confidence | Play 20 runs, and survive 10 minutes in one |

Unlocks are checked at the end of every run against your lifetime numbers, so a planet unlocks the moment you have earned it and the Game Over screen tells you which. Saves from an older planet list carry over: each kept planet stays unlocked and stays the planet you were wearing, and a removed one falls back to Stillwater.
